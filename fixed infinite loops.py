...
print()
print("The battlefild is filled with the decaying green bodies of the enemy, the ground running green with blood.")
...
# We fixed this code by chaning the while to > 0